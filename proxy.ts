...
function buildCsp(nonce: string): string {
  ...
  return [
    ...
    // purveyor-undead-oops.ngrok-free.dev: MinIO-backed creative thumbnails on /sentimentos (silver_social_comments.creative_image_path via MINIO_PUBLIC_BASE_URL, see resolveThumbUrl in app/api/sentimentos/data/route.ts)
    "img-src 'self' data: https://*.public.blob.vercel-storage.com https://*.fbcdn.net https://www.facebook.com https://*.tiktokcdn.com https://purveyor-undead-oops.ngrok-free.dev",
